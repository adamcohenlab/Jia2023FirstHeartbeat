...
for file_path in files:
    ...
    y_projection = utils.project_y(img, z_to_x_ratio=z_um/x_um)
    imsave(os.path.join(output_folder, ("%s_max_y.tif" % filename)), y_projection.astype(np.uint8), imagej=True)
