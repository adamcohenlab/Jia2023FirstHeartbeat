...
def sort_spikes(all_spikes, spike_metadata, n_lilli=None, n_neighbors=150, leiden_res=0.05):
    ...
    graph = igraph.Graph.Adjacency((adj_matrix>0).todense().tolist(), mode="undirected")
