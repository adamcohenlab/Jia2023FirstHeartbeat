function single_sim_LIF(s, r, reset, t_end, dt_set, n_repeats, output_path)
    tic
    ...
    disp(n_peaks);
    save(fullfile(output_path, sprintf('sigma_%f_r_%f.mat', s, r)), "s", "r", "isi_mu", "isi_std", "f", "y_end", "dt_set", "t_total", "n_peaks", "last_peak", "all_isis");
    disp(toc)
end
