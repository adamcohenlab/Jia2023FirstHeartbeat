...
python3 /n/holyscratch01/cohen_lab/bjia/SpikeCounter/preprocess_stim_experiment2.py $1 $2 $3 --output_folder $4 --remove_from_start $5 --remove_from_end $6 --scale_factor $7 --start_from_downsampled $8 --n_pcs $9 --skewness_threshold ${10} --left_shoulder ${11} --right_shoulder ${12} --invert ${13} --pb_correct_method ${14} --lpad ${15} --rpad ${16} --decorr_pct ${17} --pb_correct_mask ${18} --denoise ${19} --decorrelate ${20} --bg_const ${21}