...
python3 $SPIKECOUNTER_PATH/scripts/sta_snapt.py $1 $2 --subfolder $3 --s $4 --n_knots $5 --sta_before_s $6 --sta_after_s $7 --normalize_height $8 --bootstrap_n $9 --stim_channel ${10}