...
input_path = "/mnt/d/Documents/Cohen_Lab/Data/20200827_axis_duplication_hcrs"
...
for f in os.listdir(input_path):
    ...
    if not os.path.isdir(full_path):
        ...
        if extname == ".lsm":
            ...
            tifffile.imsave(os.path.join(input_path, "maxproj",  "%s_MAX.tif" % filename), lsm.max(axis=2), imagej=True, resolution=(1/pixel_data.PhysicalSizeX, 1/pixel_data.PhysicalSizeY), metadata={'unit': 'um'})
